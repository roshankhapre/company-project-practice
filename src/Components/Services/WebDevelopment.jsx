    ...
    <div className="bg-gray-100 min-h-screen py-10 px-5">
      ...
      <div className="relative mb-10">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-center text-white bg-black bg-opacity-50 rounded-lg">
          ...
          <button className="bg-gradient-to-r from-red-500 to-red-700 hover:from-red-600 hover:to-red-800 text-white font-bold py-2 px-6 rounded-full flex items-center transition-all duration-300">
            Contact Us
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {/* Card Component */}
        <div className="bg-white rounded-lg shadow-lg hover:shadow-2xl transition-transform duration-300 overflow-hidden flex flex-col">
      ...
      <div className="mt-32">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 justify-center">
          <div className="bg-white rounded-full shadow-lg p-6 flex flex-col items-center text-center transition-transform transform hover:scale-105 hover:shadow-2xl">
